...
is(lc($hex_out), 'deadbeef', 'Hex output for decimal 3735928559 matches deadbeef');

# 2. Test BN_dec2bn updating an existing BIGNUM object
my $chars_parsed2 = BN_dec2bn($bn, "305419896"); # 12345678 in hex is 305419896
is($chars_parsed2, 9, 'Parsed 9 characters on existing BIGNUM');
my $hex_out2 = BN_bn2hex($bn);
is(lc($hex_out2), '12345678', 'Existing BIGNUM value updated successfully to 12345678');
