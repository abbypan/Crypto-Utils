...
use Test::More;
use Crypto::Utils::OpenSSL qw(BN_value_one BN_one BN_zero BN_bn2hex BN_hex2bn BN_new BN_CTX_new BN_add BN_sub BN_mod bn_mod BN_rand_range);
...
ok($rnd_val >= 0 && $rnd_val < 10, "BN_rand_range generated value ($rnd_val) is within [0, 9]");
